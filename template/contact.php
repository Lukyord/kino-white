...
<main id="main" class="contact-main">
    <section class="sc contact-hero">
        <div class="contact-info">
            <div class="header">
                <h1 class="size-h1 uppercase weight-bold margin-bottom-sm" data-split data-split-animate>Contact Us</h1>
                <p class="size-h3 animate fadeIn">Lorem ipsum dolor sit amet consectetur. Proin morbi risus commodo scelerisque proin viverra.</p>
            </div>
            <div class="info">
